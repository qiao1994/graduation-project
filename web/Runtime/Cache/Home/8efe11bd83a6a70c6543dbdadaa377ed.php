    ...
    <div class="admin">
        <div class="panel admin-panel">
            ...
            <form action="" method="get">
                <div class="line">
                    <div class="x4">
                        <input type="text" class="input find" id="id" name="id" value="<?php echo ($findData['id']); ?>" placeholder="请输入菜品编号">
                    </div>
                    <div class="x4">
                        <input type="text" class="input find" id="name" name="name" value="<?php echo ($findData['name']); ?>" placeholder="请输入菜品名称">
                    </div>
                    <div class="x4">
            ...
            <table class="table table-hover">
                <tr>
                    ...
                    <th width="15%" style="text-align:center;">商家</th>
                    <th width="20%" style="text-align:center;">名称</th>
                    <th width="10%" style="text-align:center;">单价</th>
                    <th width="15%" style="text-align:center;">销售状态</th>
                ...
                <?php if(is_array($goods['list'])): $i = 0; $__LIST__ = $goods['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr align="center">
                        ...
                        <td>
                        <a class="button border-blue button-little" href="/Home/Admin/goodsUpdate/id/<?php echo ($vo['id']); ?>">编辑</a> 
                        <a class="button border-green button-little" href="/Home/Admin/goodsComment/goods_id/<?php echo ($vo['id']); ?>">评价</a>
