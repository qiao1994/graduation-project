        ...
        <div class="righter nav-navicon" id="admin-nav">
            <div class="mainer">
                <div class="admin-navbar">
                    ...
                    <ul class="nav nav-inline admin-nav">
                        <li class="<?php echo ($header['index']); ?>">
                            ...
                            <ul>
                                <li><a href="system.html">用户管理</a></li>
                                <li><a href="system.html">商家管理</a></li>
                                <li><a href="system.html">菜品管理</a></li>
                            </ul>
                        </li>
                        <li class="<?php echo ($header['user']); ?>">
                            <a href="/Home/Seller/user" class="icon-user"> 用户</a>
                            <ul>
                                <li class="<?php echo ($header['user_user']); ?>"><a href="/Home/Seller/user">用户列表</a></li>
                                <li class="<?php echo ($header['user_seller']); ?>"><a href="/Home/Seller/seller">商家用户</a></li>
                            </ul>
                        </li>
                        <li class="<?php echo ($header['shop']); ?>">
                            <a href="/Home/Seller/shop" class="icon-bank"> 商家</a>
                            <ul>
                                <li class="<?php echo ($header['shop_shop']); ?>"><a href="/Home/Seller/shop">商家列表</a></li>
                            </ul>
                        </li>
                ...
                <div class="admin-bread">
                    <!-- <span>您好，<?php echo ($admin['username']); ?>，欢迎您的光临。</span> -->
                    <ul class="bread">
